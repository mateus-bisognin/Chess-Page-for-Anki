  ...
  function Kn(e, t) {
    ...
    const m = (e) => P(100, () => lichess.sound.play(e)),
      ...
      y = {
        ...
        capture: m("capture"),
        check: m("check"),
        good: k("lisp/PuzzleStormGood", 0.7, 500),
        end: k("lisp/PuzzleStormEnd", 1, 1e3),
      };
    let z = !1;
    function S(e) {
      var t;
    ...
    async function W(e) {
      ...
      const i = await (function (e, t, n, o, r, i) {
        return x(`/training/complete/${t}/${e}`, {
          method: "POST",
          body: _({
            win: n,
            ...(r ? { replayDays: r.days } : {}),
            ...(i ? { streakId: i.nextId(), streakScore: i.data.index } : {}),
            rated: o(),
          }),
        });
      })(r.puzzle.id, r.theme.key, e, l, r.replay, h);
      if (i.replayComplete && r.replay)
        return lichess.redirect(`/training/dashboard/${r.replay.days}`);
      i.next.user &&
        r.user &&
        ((r.user.rating = i.next.user.rating),
        (r.user.provisional = i.next.user.provisional),
        (o.round = i.round),
        (null === (n = i.round) || void 0 === n ? void 0 : n.ratingDiff) &&
          f.setRatingDiff(r.puzzle.id, i.round.ratingDiff)),
      ...
      e.streak && !n
        ? ((e) => {
            ...
            return [
              ...
              d("a.continue", { attrs: { href: "/streak" } }, [
                d("i", { attrs: On("") }),
                e.trans("newStreak"),
              ]),
            ];
