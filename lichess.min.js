...
!(function () {
  var u = "displayController",
    ...
    h = { none: 0, top: 1, bottom: 2, left: 4, right: 8 };
  function d() {
    var o = this;
    (o.top = "auto"),
      (o.left = "auto"),
      ...
      (o.bottom = "auto"),
      (o.set = function (e, t) {
        $.isNumeric(t) && (o[e] = Math.round(t));
      });
  }
  function i(o, i, n) {
    var s = null,
      r = w.scoped[i.popupId];
    function c(e, t) {
      p(),
        o[0][l] ||
          (e
            ? (t && (o[0][f] = !0), n.showTip(o))
            : ((r.tipOpenImminent = !0),
              (s = setTimeout(function () {
                var e, t;
                (s = null),
                  (e = Math.abs(w.previousX - w.currentX)),
                  (t = Math.abs(w.previousY - w.currentY)),
                  e + t < i.intentSensitivity
                    ? n.showTip(o)
                    : ((w.previousX = w.currentX),
                      (w.previousY = w.currentY),
                      c());
              }, i.intentPollInterval))));
    }
    function p() {
      (s = clearTimeout(s)), (r.delayInProgress = !1);
    }
    (this.show = c),
        ...
        p(),
          ...
          o[0][l] &&
            ...
            e
              ...
              : ((r.delayInProgress = !0),
                (s = setTimeout(function () {
                  (s = null), n.hideTip(o), (w.delayInProgress = !1);
                }, i.closeDelay))));
      }),
      (this.cancel = p),
  ...
  function e() {
    this.compute = function (e, t, o, i, n) {
      var s = t.split("-")[0],
        r = new d(),
        c = (function (e, t) {
          var o,
          ...
          switch (t) {
            case "n":
              (o = n.left + s / 2), (i = n.top);
              break;
            case "e":
              (o = n.left + s), (i = n.top + r / 2);
              break;
            case "s":
              (o = n.left + s / 2), (i = n.top + r);
              break;
            case "w":
              (o = n.left), (i = n.top + r / 2);
              break;
            case "nw":
              (o = n.left), (i = n.top);
              break;
            ...
            case "sw":
              ...
              break;
            case "se":
              (o = n.left + s), (i = n.top + r);
          }
          return { top: i, left: o };
        })(e, s);
      switch (t) {
        case "n":
          r.set("left", c.left - o / 2),
            r.set("bottom", w.windowHeight - c.top + n);
          break;
        case "e":
          r.set("left", c.left + n), r.set("top", c.top - i / 2);
          break;
        case "s":
          r.set("left", c.left - o / 2), r.set("top", c.top + n);
          break;
        case "w":
          r.set("top", c.top - i / 2),
            r.set("right", w.windowWidth - c.left + n);
          break;
        case "nw":
          r.set("bottom", w.windowHeight - c.top + n),
            r.set("right", w.windowWidth - c.left - 20);
          break;
        case "ne":
          ...
          break;
        case "sw":
          r.set("top", c.top + n), r.set("right", w.windowWidth - c.left - 20);
          break;
        case "se":
          r.set("left", c.left - 20), r.set("top", c.top + n);
      }
      return r;
    };
  }
  function n(r) {
    var c = new e(),
      p = $("#" + r.popupId),
      o = w.scoped[r.popupId];
    function i(e) {
      (o.isClosing = !0),
        (o.activeHover = null),
        (o.isTipOpen = !1),
        (o.desyncTimeout = clearInterval(o.desyncTimeout)),
        (e[0][l] = !1),
        (e[0][f] = !1),
        p.hide();
      e = new d();
      (o.isClosing = !1),
        p.removeClass(),
        e.set("top", w.currentY + r.offset),
        e.set("left", w.currentX + r.offset),
        p.css(e);
    }
    function n(i) {
      var e;
          ...
          $.each(e, function (e, t) {
            var o = (function (e, t, o) {
              var i = w.scrollTop,
                ...
                r = n + w.windowWidth,
                c = h.none;
              (e.top < i || Math.abs(e.bottom - w.windowHeight) - o < i) &&
                (c |= h.top);
              (e.top + o > s || Math.abs(e.bottom - w.windowHeight) > s) &&
                (c |= h.bottom);
              (e.left < n || e.right + t > r) && (c |= h.left);
              (e.left + t > r || e.right < n) && (c |= h.right);
              return c;
            })(
              s(i, t),
              p.outerWidth() || r.defaultSize[0],
              p.outerHeight() || r.defaultSize[1]
            );
            if (o === h.none) return !1;
          }))
        : (s(i, r.placement), r.placement);
    }
    function s(e, t) {
      var o,
        i,
        ...
        s = new d();
      for (
        s.set("top", 0), s.set("left", 0), p.css(s);
        (o = p.outerWidth() || r.defaultSize[0]),
          (i = p.outerHeight() || r.defaultSize[1]),
          (s = c.compute(e, t, o, i, r.offset)),
          p.css(s),
          ++n <= 5 && (o !== p.outerWidth() || i !== p.outerHeight());
    ...
    function a() {
      ...
      !o.isTipOpen ||
        ...
        ((e =
          !1 === o.activeHover[0][l] ||
          o.activeHover.is(":disabled") ||
          !(
            t(o.activeHover) ||
            o.activeHover.is(":focus") ||
            o.activeHover[0][f] ||
            t(p)
          )
            ? !0
    ...
    o || (w.scoped[r.popupId] = o = {}),
      0 === p.length &&
        ((p = $('<div id="' + r.popupId + '"/>')), $("body").append(p)),
      p.on({
        mouseenter: function () {
          o.activeHover && o.activeHover[0][u].cancel();
        },
        mouseleave: function () {
          o.activeHover && o.activeHover[0][u].hide();
        },
      }),
      (this.showTip = function (e) {
        (e[0][l] = !0),
          (function e(t) {
            ...
            n(t);
            p.show();
            o.desyncTimeout || (o.desyncTimeout = setInterval(a, 500));
          })(e);
      }),
      (this.hideTip = i),
  ...
  function s(e) {
    (w.currentX = e.pageX), (w.currentY = e.pageY);
  }
  function t(e) {
    var t = e.offset();
    return (
      w.currentX >= t.left &&
      w.currentX <= t.left + e.width() &&
      w.currentY >= t.top &&
      w.currentY <= t.top + e.height()
    );
  }
  ($.fn.powerTip = function (e) {
    ...
    return (
      (function () {
        {
          ...
          w.mouseTrackingActive ||
            ((w.mouseTrackingActive = !0),
            (e = $(window)),
            (w.scrollLeft = window.scrollX),
            (w.scrollTop = window.scrollY),
            (w.windowWidth = e.width()),
            (w.windowHeight = e.height()),
            document.addEventListener("mousemove", s),
            window.addEventListener(
              "resize",
              function () {
                (w.windowWidth = e.width()), (w.windowHeight = e.height());
              },
              { passive: !0 }
            ),
            window.addEventListener(
              ...
              function () {
                var e = window.scrollX,
                  t = window.scrollY;
                e !== w.scrollLeft &&
                  ((w.currentX += e - w.scrollLeft), (w.scrollLeft = e)),
                  t !== w.scrollTop &&
                    ((w.currentY += t - w.scrollTop), (w.scrollTop = t));
              },
              { passive: !0 }
            ));
        }
      ...
      this.each(function () {
        var e = $(this);
        this[u] && $.powerTip.destroy(e), (this[u] = new i(e, t, o));
      }),
      this.on({
        ...
        return (
          t
            ? (s(t),
              ...
              (w.previousY = t.pageY),
              $(e)[0][u].show())
            : $(e).first()[0][u].show(!0, !0),
          e
        );
      },
      reposition: function (e) {
        return $(e).first()[0][u].resetPosition(), e;
      },
      hide: function (e, t) {
        return $(e).first()[0][u].hide(t), e;
      },
      destroy: function (e) {
        return (
          $(e)
            .off(".powertip")
            .each(function () {
              delete this[u], delete this[l], delete this[f];
            }),
          e
        );
      },
...
!(function () {
  ...
  e.prototype = {
    ...
    _enableMobileAudio: function () {
      ...
      const t = ["touchstart", "touchend", "click"];
      var o = function () {
        ...
        (n.buffer = e._scratchBuffer),
          ...
          (n.onended = function () {
            n.disconnect(0),
              ...
              t.forEach((e) => document.removeEventListener(e, o, !0));
          });
      };
      return t.forEach((e) => document.addEventListener(e, o, !0)), e;
    },
          ...
          "running" === e.state && e._suspendTimer
            ...
            ? ((e.state = "resuming"),
              e.ctx.resume().then(function () {
                (e.state = "running"),
                  e._howls.forEach((e) => e._emit("resume"));
              }),
              e._suspendTimer &&
                (clearTimeout(e._suspendTimer), (e._suspendTimer = null)))
  ...
  t.prototype = {
    ...
    play: function () {
      ...
      if (e._webAudio) {
        ...
        "loaded" === e._state && r
          ? u()
          : (e.on(r ? "load" : "resume", u, r ? t._id : null, 1),
            e._clearTimer(t._id));
      } else {
        var i = function () {
            (o.currentTime = 0),
          ...
          d = "loaded" === e._state;
        if (4 === o.readyState || d) i();
        else {
          var s = function () {
            i(), o.removeEventListener(n._canPlayEvent, s, !1);
          };
  ...
  var u = {},
    r = function (e) {
      var t = e._src;
      u[t]
        ? ((e._duration = u[t].duration), i(e))
        : fetch(t, {})
            .then((t) => {
              t.ok
                ? t.arrayBuffer().then((t) =>
                    n.ctx.decodeAudioData(t, (n) => {
                      n && e._sounds.length > 0 && ((u[e._src] = n), i(e, n));
                    })
                  )
                : Promise.reject();
            })
...
!(function () {
  ...
  const e = (e) => `lichess-${e}`,
    ...
    s = (t, s, n) => (t[e(s)] = n),
    n = (e) => {
      const [t, s, n] = e.getAttribute("data-state").split(",");
      o(e, t, s, n);
    },
    o = (e, t, o, i) => {
      window.Chessground
        ? s(
            e,
            "chessground",
            window.Chessground(e, {
              orientation: o,
              coordinates: !1,
              viewOnly: !e.getAttribute("data-playable"),
              fen: t,
              lastMove:
                i && ("@" === i[1] ? [i.slice(2)] : [i[0] + i[1], i[2] + i[3]]),
    ...
    i = (e) =>
      Array.from(
        (e || document).getElementsByClassName("mini-board--init")
      ).forEach(n);
  var a = Object.freeze({ __proto__: null, init: n, initWith: o, initAll: i });
  const r = (e) => (e.indexOf(" b") > 0 ? "black" : "white"),
    c = (e) => {
      if (window.Chessground) {
        const [t, n, o] = e.getAttribute("data-state").split(","),
          i = {
            coordinates: !1,
            viewOnly: !0,
            fen: t,
            orientation: n,
            lastMove:
              o && ("@" === o[1] ? [o.slice(2)] : [o[0] + o[1], o[2] + o[3]]),
            drawable: { enabled: !1, visible: !1 },
          },
          a = $(e).removeClass("mini-game--init"),
          c = a.find(".cg-wrap"),
          l = r(t);
        s(c[0], "chessground", window.Chessground(c[0], i)),
          ["white", "black"].forEach((e) =>
            a.find(".mini-game__clock--" + e).each(function () {
              $(this).clock({
      ...
      } else setTimeout(() => c(e), 200);
      return e.getAttribute("data-live");
    },
    l = (e) => {
      const t = Array.from(
        (e || document).getElementsByClassName("mini-game--init")
      )
        .map(c)
        .filter((e) => e);
      t.length;
      // &&
      // lichess.StrongSocket?.firstConnect.then((e) =>
      //   e("startWatching", t.join(" "))
      // );
    },
    h = (e, s) => {
      const n = $(e),
        o = s.lm,
        i = o && ("@" === o[1] ? [o.slice(2)] : [o[0] + o[1], o[2] + o[3]]),
        a = t(e.querySelector(".cg-wrap"), "chessground");
      a && a.set({ fen: s.fen, lastMove: i });
      const c = r(s.fen),
        l = (e, t) => {
          isNaN(e) ||
            n
              .find(".mini-game__clock--" + t)
              .clock("set", { time: e, pause: t != c });
        };
      l(s.wc, "white"), l(s.bc, "black");
    },
    d = (e, t) =>
      ["white", "black"].forEach((s) => {
        const n = $(e)
          .find(".mini-game__clock--" + s)
          .each(function () {
            $(this).clock("destroy");
          });
        n.data("managed") ||
  ...
  const m = [60, 3600, 86400, 604800, 2628e3, 31536e3],
    p = [...m];
  p[2] *= 2;
  const g = (e) =>
      e instanceof Date ? e : new Date(isNaN(e) ? e : parseInt(e)),
    f = (e) => {
      let t = 0;
      e < 0 && ((t = 1), (e = -e));
      const s = e;
      ...
      return (
        n > 0 && (e /= m[n - 1]),
        (n *= 2),
        (e = Math.floor(e)) > (0 === n ? 9 : 1) && (n += 1),
        lichess.timeagoLocale(e, n, s)[t].replace("%s", e)
      );
    };
  let b;
  const v = () =>
      (b =
        ...
        (window.Intl && Intl.DateTimeFormat
          ...
          : (e) => e.toLocaleString())),
    w = (e) => f((Date.now() - g(e).getTime()) / 1e3),
    y = (e) =>
      requestAnimationFrame(() => {
        const t = Date.now();
        [].slice
          .call((e || document).getElementsByClassName("timeago"), 0, 99)
          .forEach((e) => {
            const s = e.classList,
              n = s.contains("abs"),
              o = s.contains("set");
            if (
              ((e.lichessDate = e.lichessDate || g(e.getAttribute("datetime"))),
              !o)
            ) {
              const t = v()(e.lichessDate);
              n ? (e.textContent = t) : e.setAttribute("title", t),
                s.add("set"),
                (n || s.contains("once")) && s.remove("timeago");
            }
            if (!n) {
              const n = (t - e.lichessDate.getTime()) / 1e3;
              (e.textContent = f(n)), Math.abs(n) > 9999 && s.remove("timeago");
            }
          });
      }),
    k = (e) => {
      y(), setTimeout(() => k(1.1 * e), e);
    },
    S = (e) => null != e,
    C = { cache: "no-cache", credentials: "same-origin" },
    ...
    L = (e, t) => {
      window.requestIdleCallback
        ? window.requestIdleCallback(e, t ? { timeout: t } : void 0)
  ...
  let O;
  const I = () => {
      O && clearTimeout(O), (O = void 0), $("#announce").remove();
    },
    D = (e) => {
      I(),
        e.msg &&
          ($("body")
            .append(
              '<div id="announce" class="announce">' +
                M(e.msg) +
                (e.date
                  ? '<time class="timeago" datetime="' + e.date + '"></time>'
                  : "") +
                '<div class="actions"><a class="close">×</a></div></div>'
            )
            .find("#announce .close")
            .on("click", I),
          (O = setTimeout(
            I,
            e.date ? new Date(e.date).getTime() - Date.now() : 5e3
          )),
          e.date && lichess.contentLoaded());
    };
  function x() {
    $("#agreement form").on("submit", (e) => {
      const t = e.target;
      return (
        ((e) => {
          const t = e.getAttribute("action");
          t
            ? T(t, { method: e.method, body: new FormData(e) })
  ...
  function N(e, t, s) {
    ...
    let o = !1,
      ...
      a = performance.now();
    const r = () => {
        i || s(), (i = !0), (a = performance.now()), c();
      },
      c = () => {
        o && (n.forEach((e) => document.removeEventListener(e, r)), (o = !1));
      };
    setInterval(() => {
      i && performance.now() - a > e && (t(), (i = !1)),
        o || (n.forEach((e) => document.addEventListener(e, r)), (o = !0));
    }, 1e4);
  }
  let P;
  try {
    const e = window.crypto.getRandomValues(new Uint8Array(9));
    P = btoa(String.fromCharCode(...e)).replace(/[/+]/g, "_");
  } catch (Ee) {
  ...
  const F = (e) => {
      ...
      if ("string" == typeof e) t = e;
        ...
        const t = document.domain.replace(/^.+(\.[^.]+\.[^.]+)$/, "$1"),
          s = [
            encodeURIComponent(e.cookie.name) + "=" + e.cookie.value,
            "; max-age=" + e.cookie.maxAge,
            "; path=/",
            "; domain=" + t,
          ].join("");
        document.cookie = s;
    ...
    j = () => {
      U ||
        ...
        location.hash ? location.reload() : location.assign(location.href));
    },
    V = (e) => {
      const t = {
        get: (t) => e.getItem(t),
        ...
        fire: (t, s) =>
          e.setItem(
            t,
            JSON.stringify({ sri: q, nonce: Math.random(), value: s })
          ),
        ...
        make: (s) => ({
          ...
          listen: (t) =>
            window.addEventListener("storage", (n) => {
              if (n.key !== s || n.storageArea !== e || null === n.newValue)
                return;
              let o;
              try {
              ...
              (null == o ? void 0 : o.sri) && o.sri !== q && t(o);
            }),
        }),
        makeBoolean: (e) => ({
          get: () => "1" == t.get(e),
    ...
    // W = V(window.sessionStorage || {});
  class H {
    constructor(e, t, s = {}) {
      (this.url = e),
        (this.pubsub = lichess.pubsub),
        (this.ackable = new J((e, t, s) => this.send(e, t, s))),
          ...
          try {
            ...
            (t.onerror = (e) => this.onError(e)),
              ...
              (t.onopen = () => {
                ...
                t.remove("offline"),
                  t.add("online"),
                  t.toggle("reconnected", this.nbConnects > 1),
                  this.pingNow(),
        ...
        (this.send = (e, t, s = {}, n = !1) => {
          const o = { t: e };
          void 0 !== t &&
            (s.withLag && (t.l = Math.round(this.averageLag)),
            s.millis >= 0 && (t.s = Math.round(0.1 * s.millis).toString(36)),
            (o.d = t)),
            s.ackable && ((o.d = o.d || {}), this.ackable.register(e, o.d));
          ...
          if ("racerScore" != e || s.sign == this._sign) {
            if ("move" == e && s.sign != this._sign) {
              ...
              try {
                ...
                e = `${a.message} ${navigator.userAgent}`;
              }
              e.includes("round.nvui") ||
                setTimeout(
                  () => this.send("rep", { n: `soc: ${i} ${e}` }),
                  1e4
                );
            }
            this.debug("send " + i);
            try {
              ...
              n || setTimeout(() => this.send(e, o.d, s, !0), 1e3);
            }
          }
        }),
        (this.scheduleConnect = (e) => {
          this.options.idle && (e = 1e4 + 10 * Math.random() * 1e3),
        ...
        (this.computePingDelay = () =>
          this.options.pingDelay + (this.options.idle ? 1e3 : 0)),
        (this.pong = () => {
          clearTimeout(this.connectSchedule),
            this.schedulePing(this.computePingDelay());
          const e = Math.min(performance.now() - this.lastPingTime, 1e4);
          this.pongCount++;
          const t = this.pongCount > 4 ? 0.1 : 1 / this.pongCount;
          (this.averageLag += t * (e - this.averageLag)),
            this.pubsub.emit("socket.lag", this.averageLag);
        }),
        (this.handle = (e) => {
          if (e.v && !1 !== this.version) {
            if (e.v <= this.version)
              return void this.debug("already has event " + e.v);
            if (e.v > this.version + 1) return j();
            this.version = e.v;
          }
          switch (e.t || !1) {
            case !1:
            ...
            case "ack":
              ...
              break;
            default:
              (this.settings.receive && this.settings.receive(e.t, e.d)) ||
                (this.pubsub.emit("socket.in." + e.t, e.d, e),
                this.settings.events[e.t] &&
                  this.settings.events[e.t](e.d || null, e));
          }
        }),
        (this.debug = (e, t = !1) => {
        ...
        (this.disconnect = () => {
          ...
          e &&
            ...
            (e.onerror = e.onclose = e.onopen = e.onmessage = () => {}),
            e.close());
        }),
        (this.onError = (e) => {
        ...
        (this.onSuccess = () => {
          if ((this.nbConnects++, 1 == this.nbConnects)) {
            let e;
            H.resolveFirstConnect(this.send),
              N(
                6e5,
                () => {
                  (this.options.idle = !0),
                    (e = setTimeout(this.destroy, 72e5));
                },
                () => {
                  (this.options.idle = !1),
                    this.ws ? clearTimeout(e) : location.reload();
                }
              );
          }
        }),
        (this.baseUrl = () => {
          const e = document.body.dataset.socketDomains.split(",");
        ...
        (this.settings = {
          receive: s.receive,
          events: s.events || {},
          params: { ...H.defaultParams, ...(s.params || {}) },
        }),
        (this.options = { ...H.defaultOptions, ...(s.options || {}) }),
        (this.version = t),
  ...
  (H.defaultOptions = {
    ...
    (H.defaultParams = { sri: q }),
    (H.firstConnect = new Promise((e) => {
      H.resolveFirstConnect = e;
    }));
  class J {
    constructor(e) {
      (this.send = e),
        (this.currentId = 1),
        (this.messages = []),
        (this.sign = (e) => (this._sign = e)),
        (this.resend = () => {
          const e = performance.now() - 2500;
          this.messages.forEach((t) => {
            t.at < e && this.send(t.t, t.d, { sign: this._sign });
          });
        }),
        (this.register = (e, t) => {
          (t.a = this.currentId++),
            this.messages.push({ t: e, d: t, at: performance.now() });
        }),
        (this.onServerAck = (e) => {
  ...
  const G = (e, t = {}) => {
    ...
    X = (e) => {
      if (!z.has(e)) {
        ...
        (t.rel = "stylesheet"), (t.href = G(e)), document.head.append(t);
      }
    },
    K = (e) =>
      X(
        `css/${e}.${$("body").data("theme")}.${
          $("body").data("dev") ? "dev" : "min"
        }.css`
      ),
    Y = (e) => `compiled/${e}${$("body").data("dev") ? "" : ".min"}.js`,
    Q = new Map(),
    Z = (e, t = {}) => {
      var s;
      return (
    ...
    ee = (e) => Z(Y(e)),
    te = () => (
      K("complete"), ee("userComplete").then((e) => window.UserComplete)
    ),
    se = () => (
      X("vendor/hopscotch/dist/css/hopscotch.min.css"),
      Z("vendor/hopscotch/dist/js/hopscotch.min.js", { noVersion: !0 })
    ),
    ne = (e) =>
      new Promise((t) =>
        requestAnimationFrame(() => {
          (e.loadCss = K),
            t(window.LichessChat(document.querySelector(".mchat"), e));
        })
      );
  function oe(e, t) {
    // return "always" === t || (!B.get(e) && (B.set(e, "1"), !0));
    return "always" === t
  }
  const ie =
    ...
    ae = (e) => {
      var t;
      return null === (t = document.querySelector(".crosstable")) ||
        void 0 === t
        ? void 0
        : t.contains(e);
    };
  ...
  const ce = (e, t) =>
      `<a class="btn-rack__btn" href="${e}" data-icon="${t}"></a>`,
    le = (e, t) => {
      (t = t || e.getAttribute("data-pt-pos") || (ae(e) ? "n" : "s")),
        $(e)
          .removeClass("ulpt")
          .powerTip({
            preRender: re("powerTip", (t) => {
              const s = t.substr(3),
  ...
  function ue(e, t, s) {
    L(
      () => Array.prototype.forEach.call(e.querySelectorAll(t), (e) => s(e)),
      800
    );
  }
  const me = {
        ...
        ($.fn[e] = function (n) {
          ...
          return (
            "string" == typeof n
              ? this.each(function () {
                  const s = t(this, e);
                  s && $.isFunction(s[n]) && s[n].apply(s, i);
                })
              : this.each(function () {
                  t(this, e) || s(this, e, new o(n, this));
                }),
            this
          );
        });
    ...
    fe = {
      ...
      emit(e, ...t) {
        for (const s of ge[e] || []) s.apply(null, t);
      },
    };
  function be(e, t) {
    if (t.length)
      if (e.includes("%s")) e = e.replace("%s", t[0]);
      else
        for (let s = 0; s < t.length; s++)
          e = e.replace("%" + (s + 1) + "$s", t[s]);
    return e;
  }
  function ve(e, t) {
    ...
    if (t.length) {
      ...
      if (-1 !== e) s[e] = t[0];
        ...
        for (let n = 0; 1 < t.length; n++) {
          const e = s.indexOf("%" + (n + 1) + "$s");
          -1 !== e && (s[e] = t[n]);
        }
    }
    return s;
  ...
  function we(e) {
    ...
    return (
      (t.plural = function (t, s) {
        const n = `${t}:${lichess.quantity(s)}`,
          o = e[n] || e[t];
        return o ? be(o, Array.prototype.slice.call(arguments, 1)) : t;
      }),
      (t.noarg = (t) => e[t] || t),
      (t.vdom = (t, ...s) => {
        const n = e[t];
  ...
  const ye = new (class {
    constructor() {
      (this.soundSetSounds = new Map()),
        (this.standaloneSounds = new Map()),
        (this.soundSet = $("body").data("sound-set")),
        // (this.speechStorage = B.makeBoolean("speech.enabled")),
        // (this.volumeStorage = B.make("sound-volume")),
        (this.baseUrl = G("sound", { version: "_____1" })),
        (this.loadOggOrMp3 = (e, t, s = !1) =>
          (s ? this.standaloneSounds : this.soundSetSounds).set(
            e,
            new Howl({ src: ["ogg", "mp3"].map((e) => `${t}.${e}`) })
          )),
        (this.loadStandard = (e, t) => {
          if (!this.enabled()) return;
          const s = e[0].toUpperCase() + e.slice(1);
          this.loadOggOrMp3(e, `${this.baseUrl}/${s}`);
        }),
        (this.getOrLoadSound = (e, t) => {
          var s;
          let n =
            null !== (s = this.soundSetSounds.get(e)) && void 0 !== s
              ? s
              : this.standaloneSounds.get(e);
          return (
            n || (this.loadStandard(e, t), (n = this.soundSetSounds.get(e))), n
          );
        }),
        ...
        //   return e >= 0 ? e : 0.7;
        // }),
        (this.enabled = () => "silent" !== this.soundSet),
        // (this.speech = (e) => (
        //   void 0 !== e && this.speechStorage.set(e), this.speechStorage.get()
        // )),
        // (this.say = (e, t = !1, s = !1, n = !1) => {
        //   if ((t && speechSynthesis.cancel(), !this.speechStorage.get() && !s))
        //     return !1;
        //   const o = new SpeechSynthesisUtterance(e);
        //   return (
        //     (o.volume = this.getVolume()),
        //     (o.lang = n ? document.documentElement.lang : "en-US"),
        //     speechSynthesis.speak(o),
        //     !0
        //   );
        // }),
        (this.sayOrPlay = (e, t) => this.say(t) || this.play(e)),
        (this.publish = () => fe.emit("sound_set", this.soundSet)),
        (this.changeSet = (e) => {
          (this.soundSet = e), this.soundSetSounds.clear(), this.publish();
        }),
        (this.set = () => this.soundSet),
        "music" == this.soundSet && setTimeout(this.publish, 500);
    }
    preloadBoardSounds() {
      "music" !== this.soundSet &&
        ["move", "capture", "check", "genericNotify"].forEach((e) =>
          this.loadStandard(e)
        );
    }
    play(e, t) {
      ...
      const o = this.getOrLoadSound(e, n),
        i = () => o.volume(this.getVolume() * (t || 1)).play();
      "suspended" ===
      (null === (s = Howler.ctx) || void 0 === s ? void 0 : s.state)
        ? Howler.ctx.resume().then(i)
        : i();
    }
    playOnce(e) {
      const t = () => {
        return;
        // const t = lichess?.storage.make("just-played");
        Date.now() - parseInt(t.get(), 10) < 1e3 ||
          (t.set("" + Date.now()), this.play(e));
      };
      document.hasFocus() ? t() : setTimeout(t, 10 + 500 * Math.random());
    }
  })();
  let ke;
  function $e(e) {
    const t = $(e);
    if (t.data("watched")) return;
    t.data("watched", 1);
    const s = $('<div class="chat__members__inner">').appendTo(t),
      n = $(
        '<div class="chat__members__number" data-icon="" title="Spectators"></div>'
      ).appendTo(s),
      o = $("<div>").appendTo(s);
    lichess.pubsub.on("socket.in.crowd", (e) => i(e.watchers || e));
    const i = (e) => {
      if (((ke = e), e && e.nb)) {
        if ((n.text("" + e.nb), e.users)) {
          const t = e.users.map((e) =>
            e
          ...
          1 === e.anons
            ? t.push("Anonymous")
            : e.anons && t.push(`Anonymous (${e.anons})`),
            o.html(t.join(", "));
        } else o.html("");
        t.removeClass("none");
      } else t.addClass("none");
    };
    ke && i(ke);
  }
  ...
  function Ce() {
    var e;
    Se.userAnalysis
      ? (((e = Se.userAnalysis).$side = $(".analyse__side").clone()), _e(e))
      : (Se.study || Se.practice || Se.relay) &&
        _e(Se.study || Se.practice || Se.relay);
  }
  function _e(e) {
    (lichess.socket = new H(
      e.socketUrl || "/analysis/socket/v5",
      e.socketVersion,
      { receive: (e, s) => t.socketReceive(e, s) }
    )),
      (e.socketSend = Se.socket.send);
    const t = window.LichessAnalyse.start(e);
  }
  class Te {
    constructor(e) {
      (this.el = e),
        ...
        (this.receive = (e, t) => {
          this.users.clear(),
            ...
            t.playing
              ...
              .filter(S)
              .forEach((e) => (e.playing = !0)),
            t.patrons
              .map((e) => this.users.get(e))
              .filter(S)
              .forEach((e) => (e.patron = !0)),
            this.repaint();
        }),
        (this.repaint = () => {
          this.loaded &&
            requestAnimationFrame(() => {
              ...
              (this.titleEl.innerHTML = this.trans.plural(
                "nbFriendsOnline",
                t.length,
                this.loaded ? `<strong>${t.length}</strong>` : "-"
              )),
                null === (e = this.el.querySelector(".nobody")) ||
                  void 0 === e ||
                  e.classList.toggle("none", !!t[0]),
                (this.el.querySelector(".list").innerHTML = t
                  .map((e) => this.renderFriend(this.users.get(e)))
                  .join(""));
            });
        }),
        (this.renderFriend = (e) => {
          const t = `<i class="line${e.patron ? " patron" : ""}"></i>`,
            s = e.title
              ? `<span class="utitle"${"BOT" === e.title ? " data-bot" : ""}>${
                  e.title
                }</span>&nbsp;`
              : "",
            n = "/@/" + e.name,
            o = e.playing
              ? `<a data-icon="" class="tv ulpt" data-pt-pos="nw" href="${n}/tv" data-href="${n}"></a>`
              : "";
          return `<div><a class="user-link ulpt" data-pt-pos="nw" href="${n}">${t}${s}${e.name}</a>${o}</div>`;
        }),
        (this.enters = (e, t) => {
        ...
        (this.insert = (e) => {
          ...
          return (
            this.users.has(t) || this.users.set(t, this.toFriend(e)),
            this.users.get(t)
          );
        }),
        (this.getId = (e) => e.toLowerCase().replace(/^\w+\s/, "")),
        (this.toFriend = (e) => {
          const t = e.split(" ");
          return {
        ...
        this.titleEl.addEventListener("click", () => {
          var e;
          null === (e = this.el.querySelector(".content_wrap")) ||
            void 0 === e ||
            e.classList.toggle("none"),
            this.loaded ||
              ((this.loaded = !0), fe.emit("socket.send", "following_onlines"));
        }),
        (this.trans = we(JSON.parse(this.el.getAttribute("data-i18n")))),
        (this.users = new Map()),
        fe.on("socket.in.following_onlines", this.receive),
        ["enters", "leaves", "playing", "stopped_playing"].forEach((e) =>
          fe.on("socket.in.following_" + e, this[e])
        );
    }
  }
  function Ae(e) {
    var t;
    const s = $("#modal-wrap")[0];
    if (!s) return;
    const n = s.compareDocumentPosition(e.target);
    if (n & Node.DOCUMENT_POSITION_CONTAINED_BY) return;
    const o = $(s).find(
        'button:not(:disabled), [href], input:not(:disabled):not([type="hidden"]), select:not(:disabled), textarea:not(:disabled), [tabindex="0"]'
      ),
      i = n & Node.DOCUMENT_POSITION_FOLLOWING ? 0 : o.length - 1;
    null === (t = o.get(i)) || void 0 === t || t.focus(), e.preventDefault();
  }
  !(function () {
    const e = window.lichess;
    (e.StrongSocket = H),
      (e.requestIdleCallback = L),
      (e.sri = q),
      // (e.storage = B),
      // (e.tempStorage = W),
      (e.once = oe),
      ...
      (e.timeago = w),
      (e.dateFormat = v),
      (e.contentLoaded = (e) => fe.emit("content-loaded", e));
  })(),
    (lichess.info = {
      date: "2022-01-26T10:14:02+00:00",
      commit: "0190572",
      message: "REVERT ME Temporary hack to fix canceling reports",
    }),
    pe("clock", {
      _create: function () {
        (this.target = 1e3 * this.options.time + Date.now()),
          this.options.pause ||
      ...
      set: function (e) {
        (this.options = e),
          ...
          e.pause || (this.interval = setInterval(this.render.bind(this), 1e3));
      },
      render: function () {
    ...
    lichess.load.then(() => {
      Ce(),
        requestAnimationFrame(() => {
          i(),
            l(),
            fe.on("content-loaded", i),
            fe.on("content-loaded", l),
            k(1e3),
            fe.on("content-loaded", y);
        }),
        L(() => {
          ...
          if (
            ...
            $("body").on("click", "a.relation-button", function () {
              const e = $(this).addClass("processing").css("opacity", 0.3);
              return (
                T(this.href, { method: "post" }).then((t) => {
                  t.includes("relation-actions")
                ...
                L(() => {
                  const t = (s) => {
                    e[0].contains(s.target) ||
                      (e.removeClass("shown"), $("html").off("click", t));
                  };
                  $("html").on("click", t);
                }, 200);
            }),
            me.watchMouse(),
            setTimeout(() => {
              lichess.socket || (lichess.socket = new H("/socket/v5", !1));
            }, 300),
            (function () {
              const e = `<div class="initiating">${ie}</div>`,
                t = (e) => {
              ...
              "ontouchstart" in window &&
                ...
                $("#top").on("click", "a.toggle", function () {
                  ...
                  return (
                    e.siblings(".shown").removeClass("shown"),
                    fe.emit("top.toggle." + this.id),
                    setTimeout(() => {
                      const t = (s) => {
                        var n;
                        (null === (n = e[0]) || void 0 === n
              ...
              {
                let s, n;
                const o = $("#challenge-toggle");
                o.one("mouseover click", () => i());
                const i = function (i) {
                  if (n) return;
                  n = !0;
                  ...
                  K("challenge"),
                    ee("challenge").then(
                      () =>
                        (s = window.LichessChallenge(a[0], {
                          data: i,
                          show() {
                            t("#challenge-app") || o.trigger("click");
                          },
                          setCount(e) {
                            o.find("span").data("count", e);
                          },
                          pulse() {
                            o.addClass("pulse");
                          },
                ...
                fe.on("socket.in.challenges", (e) => {
                  s ? s.update(e) : i(e);
                }),
                  fe.on("challenge-app.open", () => o.trigger("click"));
              }
              {
                let s, n;
                const o = $("#notify-toggle"),
                  i = "#notify-app",
                  a = (a, r = !1) => {
                    if (n) return;
                    n = !0;
                    ...
                    K("notify"),
                      ee("notify").then(
                        () =>
                          (s = window.LichessNotify(c.empty()[0], {
                            data: a,
                            incoming: r,
                            isVisible: () => t(i),
                            setCount(e) {
                ...
                o
                  ...
                  fe.on("socket.in.notifications", (e) => {
                    s ? s.update(e, !0) : a(e, !0);
                  }),
                  fe.on("notify-app.set-read", (e) => {
                    s ? s.setMsgRead(e) : a();
                  });
              }
              {
                ...
                $("#top .dasher .toggle").one("mouseover click", function () {
                  ...
                  K("dasher"),
                    ee("dasher").then(() =>
                      window.LichessDasher(s.empty()[0], { playing: n })
                    );
                });
              }
              {
            ...
            window.InfiniteScroll && window.InfiniteScroll(".infinite-scroll"),
            ...
            $("#main-wrap").on("click", "a.bookmark", function () {
              ...
              T(this.href, { method: "post" });
              const t =
                (parseInt(e.text(), 10) || 0) +
                (e.hasClass("bookmarked") ? 1 : -1);
            ...
            e.setAttribute(
              "content",
              e.getAttribute("content") + ",maximum-scale=1.0"
            );
          }
          "#blind" !== location.hash ||
            $("body").hasClass("blind-mode") ||
            T("/toggle-blind-mode", {
              method: "post",
              body: E({ enable: 1, redirect: "/" }),
            }).then(j);
          ...
          s && D(JSON.parse(s)),
            ...
            (function () {
              if (
                ...
                const e = new URL(
                  G(Y("serviceWorker"), { sameDomain: !0 }),
                  self.location.href
                );
                e.searchParams.set(
                  "asset-url",
                  ...
                  document.body.getAttribute("data-dev") &&
                    e.searchParams.set("dev", "1");
                const t = document.body.getAttribute("data-dev")
                  ? "none"
                  : "all";
                // navigator.serviceWorker
                //   .register(e.href, { scope: "/", updateViaCache: t })
                //   .then((e) => {
                //     // const t = B.make("push-subscribed"),

                //     const s = document.body.getAttribute("data-vapid");
                //     s && "granted" == Notification.permission
                //       ? e.pushManager.getSubscription().then((n) => {
                //           const o =
                //               parseInt(t.get() || "0", 10) + 432e5 < Date.now(),
                //             i = Uint8Array.from(atob(s), (e) =>
                //               e.charCodeAt(0)
                //             );
                //           (n && !o) ||
                //             e.pushManager
            ...
            fe.on("socket.in.redirect", (e) => {
              (lichess.unload.expected = !0), lichess.redirect(e);
            }),
            fe.on("socket.in.fen", (e) =>
              document
                .querySelectorAll(".mini-game-" + e.id)
                .forEach((t) => h(t, e))
            ),
            fe.on("socket.in.finish", (e) =>
              document
                .querySelectorAll(".mini-game-" + e.id)
                .forEach((t) => d(t, e.win))
            ),
            fe.on("socket.in.announce", D),
            fe.on("socket.in.tournamentReminder", (e) => {
              if (
                $("#announce").length ||
                $("body").data("tournament-id") == e.id
              )
                return;
              const t = "/tournament/" + e.id;
              $("body")
                .append(
                  `<div id="announce"><a data-icon="" class="text" href="${t}">${e.name}</a><div class="actions"><a class="withdraw text" href="${t}/withdraw" data-icon="">Pause</a><a class="text" href="${t}" data-icon="">Resume</a></div></div>`
                )
